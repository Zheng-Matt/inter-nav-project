...
class Camera(BaseSensor):
    ...
    def create_camera(self) -> i_Camera:
        ...
        return i_Camera(
            ...
            translation=None if self.config.translation is None else np.asarray(self.config.translation, dtype=float),
            orientation=None if self.config.orientation is None else np.asarray(self.config.orientation, dtype=float),
        )
